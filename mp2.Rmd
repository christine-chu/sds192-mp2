...
```
What we wanted to find weather or not there is a relationship between money and a candidate's chances of winning. Our hypothesis was that the more money a candidate received the more likely they were to win in a election. Our first step with data wrangling creating a new data frame, `Contributions 1`, which merged candidate id with candidate name. Since we wanted to observe total transaction for each candidate, we took the next step to inner join our new data frame,  `Contributions 1` with one of the original data frames `house_elections`.
...
=======
[^1]: link to the GitHub repository: https://github.com/christine-chu/sds192-mp2
>>>>>>> 52bf0aadb654563921bfa320d00bc9f82315fb79
